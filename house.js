...
function houseComputeDistrictOutcomes(districtEstimates, pollsByDistrict) {
    ...
    for (const district in districtEstimates) {
        ...
        const applied = houseRenormalizeEstimates(houseApplyPviToEstimates(district, estimates, polls));
...
async function houseGetData(url) {
    ...
    const outcomes = houseComputeDistrictOutcomes(estimates, byDistrict);
